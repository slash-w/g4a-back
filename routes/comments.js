...
import verifyCommentOwnership from "../g4a-backend/middlewares/verifyCommentOwnership.js";

let comment_router = Router();

comment_router.get("/", passport.authenticate("jwt", { session: false }));
comment_router.post("/", passport.authenticate("jwt", { session: false }), createComment);
