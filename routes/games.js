...
game_router.put("/:id", validator(gameUpdate), passport.authenticate("jwt", { session: false }), updateGame);
game_router.delete("/:id", passport.authenticate("jwt", { session: false }), destroyGame);
